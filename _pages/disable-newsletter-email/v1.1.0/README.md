---
layout: default
title: Disable Newsletter Email v1.1.0
...
permalink: /disable-newsletter-email/v1.1.0/
---

## Disable Newsletter Sign Up Emails Manual - Magento 2 Extension - v1.1.0
...
6. Run the following command: ```php -f bin/magento module:enable MageExchange_Base MageExchange_NewsletterSignupNotification --clear-static-content```
