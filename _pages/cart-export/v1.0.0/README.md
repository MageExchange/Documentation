...
## Cart Export Manual - Magento 2 Extension - v1.0.0
Welcome to the **Cart Export** Magento module documentation! As always, we appreciate your business!

This documentation contains everything you need to know from installing the module to managing the module.

Our [Cart Export Magento 2 module](https://www.mageexchange.com/cart-export-magento-2) is very helpful for Magento 2 store owners who want to allow their customers to export their shopping cart data.
...
6. Run the following command: ```php -f bin/magento module:enable MageExchange_Base MageExchange_CartExport --clear-static-content```
...
### User Configuration
**Enable Cart Export:** This will enable or disable the ability for customers to export their cart data. "Allow Logged In Customers Only" will only allow logged in customers to export their cart data. "Allow All" will allow both guests and logged in customers to export their cart data.
