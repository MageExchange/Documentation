---
layout: default
title: Magento 2 Customer Delete Account Module v1.0.0
...
6. Run the following command: ```php -f bin/magento module:enable MageExchange_CustomerDeleteAccount --clear-static-content```
